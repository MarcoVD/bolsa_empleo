# usuarios/migrations/0005_cambiar_estados_por_municipios_edomex.py
from django.db import migrations, models


class Migration(migrations.Migration):
    dependencies = [
        ('usuarios', '0004_sistema_cv'),
    ]

    operations = [
        # Agregar el nuevo campo municipio
        migrations.AddField(
            model_name='vacante',
            name='municipio',
            field=models.CharField(
                ...
                default='toluca',  # Valor temporal por defecto
            ),
        ),
        ...
        # Hacer el campo municipio obligatorio (quitar el default)
